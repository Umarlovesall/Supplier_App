 ...
 */
public class TrialOneByOne extends Fragment implements NetworkStateReceiver.NetworkStateReceiverListener{
    TextView dp2,dp1;
    ...
    String msgReply;
    SharedPreferences sp,allItemsandLocks,connectionHistory,pendingConnections;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_trial_one_by_one, container, false);
       ...
       // lv.setAdapter(m);
        ...
        setup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lock=LockText.getText().toString().trim();
                            ...
                            if (!s.equals("") && !LockText.getText().toString().trim().equals(""))
                            {
                                ...
                                if (al.contains(LockText.getText().toString().trim()))
                                {
                                   ...
                                   // ilf.setLockIdString(LockText.getText().toString().trim());
                                    ...
                                    String t= allItemsandLocks.getString("SupplierItemsDetails","");
                                    if (!t.equals("") && !ItemText.getText().toString().equals(""))
                                    {
                                        try {
                                            JSONArray j = new JSONArray(t);
